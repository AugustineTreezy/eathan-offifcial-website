...
@section('content')
    ...
    <section class="feature-section section-padding ash-white-bg">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading text-center">
                        <h2 class="section-title wow fadeInUpXsd" data-wow-duration=".7s" data-wow-delay=".1s">WHO WE <span class="base-color">ARE</span> </h2>
                        <span class="section-sub-title wow fadeInUpXsd disinb" data-wow-duration=".9s" data-wow-delay=".1s">EATHAN – East Africa Trans Health & Advocacy Network was formed
                            to fill the gap of regional trans health advocacy work in East Africa...
                        </span>
            ...
            <div class="row">
                <div class="col-md-4 col-xs-12">
                    <div class="help-us wow fadeInUpSmd" data-wow-duration="1.5s" data-wow-delay=".2s">
                        <div class="help-us__icon-wrap">
                            <i class="help-us__icon fa fa-gg"></i>
                        </div>
                        <div class="help-us__text-content">
                            <h4 class="help-us__title heading-label-four">MISSION</h4>
                            <p>Our mission is to equip and enable East African trans* diverse individuals and institutions.</p>                            
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-xs-12">
                    <div class="help-us wow fadeInUpSmd" data-wow-duration="1.5s" data-wow-delay=".4s">
                        <div class="help-us__icon-wrap">
                            <i class="help-us__icon fa fa-binoculars"></i>
                        </div>
                        <div class="help-us__text-content">
                            <h4 class="help-us__title heading-label-four">VISION</h4>
                ...
                <div class="col-md-4 col-xs-12">
                    <div class="help-us wow fadeInUpSmd" data-wow-duration="1.5s" data-wow-delay=".6s">
                        ...
                        <div class="help-us__text-content">
                            <h4 class="help-us__title heading-label-four">MEMBERSHIP</h4>
    ...
    <section class="upcomming-event-section ash-white-bg section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
    ...
    <section class="blog-section section-padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading text-center">
                        <h2 class="section-title wow fadeInUpXsd" data-wow-duration=".7s" data-wow-delay=".1s">Latest <span class="base-color">News</span></h2>
...
@section('scripts')
    ...
    <script src="{{asset('js/revolution-active.js')}}"></script>
@endsection